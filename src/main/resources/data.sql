...
INSERT INTO car (make, model, car_year, min_bid_amount, sold_out, terms) VALUES ('Honda', 'Accord', 2021, 25000.0, false, 'The car is listed at $25,000. The seller is open to negotiating within a reasonable range, but any offer below $23,000 will be politely declined. Additionally, the seller is willing to consider including an extended warranty if the offer is within $23,000 to $30,000. The car has a mileage of approximately 40,000 miles. ');
